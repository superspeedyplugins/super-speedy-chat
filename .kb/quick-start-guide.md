# Super Speedy Chat Quick Start Guide
...
1. Download the plugin `.zip` from your account on superspeedyplugins.com.
...
| **Behaviour** | Admin reply timeout and timeout action (e.g. show an email prompt or trigger an LLM auto-reply), poll intervals, notification sounds, max message length, require login. |
...
For advanced setup, see the other guides in the knowledge base:

- [Discord Integration Setup Guide](https://www.superspeedyplugins.com/kb/super-speedy-chat/getting-started/discord-integration-setup-guide/) -- full walkthrough for connecting Discord.
